...
import no.nav.aura.vmware.orchestrator.request.ProvisionRequest.Role;
import no.nav.aura.vmware.orchestrator.request.ProvisionRequest.Zone;
import no.nav.aura.vmware.orchestrator.request.ProvisionRequest.envClass;
import no.nav.aura.vmware.orchestrator.request.VApp.Site;
import no.nav.aura.vmware.orchestrator.request.Vm.MiddleWareType;
import no.nav.aura.vmware.orchestrator.request.Vm.OSType;
