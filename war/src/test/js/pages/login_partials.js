...
var LoginPartials = function() {
	...
	function doLogout() {
		return logoutButton.isDisplayed().then(
				function(loggedIn) {
					if (loggedIn) {
						// console.log("logging out");
						logoutButton.click();
						// triks for å unngå problemer med loginting som ikke
						// vises enda
						return browser.driver.wait(protractor.until.elementIsNotVisible(logoutButton), 10000,
								"LogoutButton is still visible 10 sec after logging out");
					}
				});
