...
import no.nav.vmware.ws.VSOWebControl;
import no.nav.vmware.ws.VSOWebControlService;
import no.nav.vmware.ws.Workflow;
import no.nav.vmware.ws.WorkflowToken;
import no.nav.vmware.ws.WorkflowTokenAttribute;
...
public class WorkflowExecutor {
    ...
    public WorkflowExecutor(String orcUrl, String orcUsername, String orcPassword) {
        ...
        try {
            ...
            throw new RuntimeException("Error resolving URL", mue);
        }

        VSOWebControlService service = new VSOWebControlService(url);
