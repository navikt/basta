...
public abstract class FasitProperties {
    ...
    public static final String BPM_RECOVERY_DATASOURCE_ALIAS = "bpmRecoveryDatasourceAlias";
    ...
    public static void apply(OrderDetailsDO source, Settings target) {
        ...
        target.setProperty(BPM_RECOVERY_DATASOURCE_ALIAS, source.getRecoveryDatasource());
    ...
    public static void apply(Settings source, OrderDetailsDO target) {
        ...
        target.setFailoverDatasource(source.getProperty(BPM_FAILOVER_DATASOURCE_ALIAS).orNull());
        target.setRecoveryDatasource(source.getProperty(BPM_RECOVERY_DATASOURCE_ALIAS).orNull());
