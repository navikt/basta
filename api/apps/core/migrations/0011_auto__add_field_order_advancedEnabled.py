...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.advancedEnabled'
        db.add_column(u'core_order', 'advancedEnabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.advancedEnabled'
        db.delete_column(u'core_order', 'advancedEnabled')
