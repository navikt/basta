...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Order.vmCount'
        db.delete_column(u'core_order', 'vmCount')

        # Adding M2M table for field vms on 'Order'
        m2m_table_name = db.shorten_name(u'core_order_vms')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm[u'core.order'], null=False)),
            ('vm', models.ForeignKey(orm[u'core.vm'], null=False))
        ))
        db.create_unique(m2m_table_name, ['order_id', 'vm_id'])


    def backwards(self, orm):
        # Adding field 'Order.vmCount'
        db.add_column(u'core_order', 'vmCount',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Removing M2M table for field vms on 'Order'
        db.delete_table(db.shorten_name(u'core_order_vms'))
    ...
    models = {
        ...
        u'core.order': {
            ...
            'vms': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['core.Vm']", 'null': 'True', 'symmetrical': 'False'}),
