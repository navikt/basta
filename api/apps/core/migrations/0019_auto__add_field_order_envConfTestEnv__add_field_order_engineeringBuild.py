...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.envConfTestEnv'
        db.add_column(u'core_order', 'envConfTestEnv',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Order.engineeringBuild'
        db.add_column(u'core_order', 'engineeringBuild',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.envConfTestEnv'
        db.delete_column(u'core_order', 'envConfTestEnv')

        # Deleting field 'Order.engineeringBuild'
        db.delete_column(u'core_order', 'engineeringBuild')
    ...
    models = {
        ...
        u'core.order': {
            ...
            'engineeringBuild': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'envConfTestEnv': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
