...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vm.order'
        db.add_column(u'core_vm', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['core.Order']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Vm.order'
        db.delete_column(u'core_vm', 'order_id')
