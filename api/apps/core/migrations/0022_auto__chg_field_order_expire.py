...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Order.expire'
        db.alter_column(u'core_order', 'expire', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Order.expire'
        db.alter_column(u'core_order', 'expire', self.gf('django.db.models.fields.CharField')(default='', max_length=10))
    ...
    models = {
        ...
        u'core.order': {
            ...
            'project_id': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
