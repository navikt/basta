...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.expire'
        db.add_column(u'core_order', 'expire',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.expire'
        db.delete_column(u'core_order', 'expire')
    ...
    models = {
        ...
        u'core.order': {
            ...
            'expire': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
