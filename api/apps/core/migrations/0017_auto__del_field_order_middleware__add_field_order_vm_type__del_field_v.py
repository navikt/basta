...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.vm_type'
        db.add_column(u'core_order', 'vm_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, blank=True),
                      keep_default=False)

        # Deleting field 'Vm.vm_type'
        db.delete_column(u'core_vm', 'vm_type')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.vm_type'
        db.delete_column(u'core_order', 'vm_type')

        # Adding field 'Vm.vm_type'
        db.add_column(u'core_vm', 'vm_type',
                      self.gf('django.db.models.fields.CharField')(default='ap', max_length=2),
                      keep_default=False)
