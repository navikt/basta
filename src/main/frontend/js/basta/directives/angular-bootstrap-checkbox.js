"use strict";
//Based on directive angular-bootstrap-checkbox - modified to use font awesome.
module.exports =function() {
    return {
        ...
        "ng-class=\"{'btn-xs': size==='default', 'btn-sm': size==='large', 'btn-lg': size==='largest', 'checked': checked===true}\">" +
        ...
        link: function(scope, elem, attrs, modelCtrl) {
            ...
            if(attrs.large !== undefined) {
                scope.size = "large";
                scope.stylebtn = {"padding-top": "2px", "padding-bottom": "2px", "margin-right":"-3px", "height": "30px"};
                scope.styleicon = {"width": "10px", "margin-left": "-8px", "font-size": "20px"};
            }
