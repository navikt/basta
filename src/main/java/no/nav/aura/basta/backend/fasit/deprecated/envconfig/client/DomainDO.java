...
import static no.nav.aura.basta.backend.fasit.deprecated.envconfig.client.DomainDO.EnvClass.*;
import static no.nav.aura.basta.backend.fasit.deprecated.envconfig.client.DomainDO.Zone.FSS;
import static no.nav.aura.basta.backend.fasit.deprecated.envconfig.client.DomainDO.Zone.SBS;
